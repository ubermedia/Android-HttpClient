...
/**
 * Created by Denis Babak on 04/07/16.
 */
 ...
 */
public class VolleyGenericHttpRequest<T> extends JsonRequest<T> {
     ...
     */
    private VolleyGenericHttpRequest(int method, Class<T> classtype, String url, String requestBody,
     ...
     * @param headers:       Added headers
     */
    public VolleyGenericHttpRequest(int method, String url, Class<T> classtype, Object toBeSent,
                          Response.Listener<T> listener, Response.ErrorListener errorListener, Map<String, String> headers) {
     ...
     * @param errorListener: Error handler of the request
     */
    public VolleyGenericHttpRequest(int method, String url, Class<T> classtype, String requestBody,
                          Response.Listener<T> listener, Response.ErrorListener errorListener) {
     ...
     * @param errorListener: Error handler of the request
     */
    public VolleyGenericHttpRequest(String url, Class<T> classtype, Response.Listener<T> listener, Response.ErrorListener errorListener) {
     ...
     * @param headers:       Added headers
     */
    public VolleyGenericHttpRequest(String url, Class<T> classtype, Response.Listener<T> listener, Response.ErrorListener errorListener, Map<String, String> headers) {
